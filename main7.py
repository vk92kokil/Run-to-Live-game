...
#		self.loadmenu()
 ...
 def setlig(self, task):
	for i in range(len(self.lm)):
		if(((abs(abs(self.cycle.getX())) -(abs(self.lm[i].getX()))) >= 330) and ((abs((abs(self.cycle.getY()))-(abs(self.lm[i].getY()))))>=330) ):
			#print(self.lm[i],self.lm[i].getPos())
			self.lm[i].detachNode()
			#self.lm[i].setColor(0.4,0.4,0.4,0.4)
		#else:
	...
	for i in range(len(self.bikeModel1)):
		...
		#else:
			#self.lm[i].reparentTo(self.track)
		if(((abs(abs(self.cycle.getX())) -(abs(self.bikeModel1[i].getX()))) > 200) and ((abs((abs(self.cycle.getY()))-(abs(self.bikeModel1[i].getY()))))>200) ):
			#print(self.heartModel1[i],self.heartModel1[i].getPos())
 ...
 def createmap(self ):
	...
	pandaPosInterval1c = self.ap5.posInterval(9,
                                                        Point3(-711,464,70),
                                                        startPos=Point3(-238,670.8,5))
        
	#pandaPosInterval2c= self.h1ba.posInterval(3,
    #                                                    Point3(-634,-401,2),
    #                                                    startPos=Point3(-571,-451,2))
        
	#pandaPosInterval3c = self.h1ba.posInterval(3,
    #                                                    Point3(-571,-451,2),
    #                                                    startPos=Point3(-634,-401,2))
	
	#pandaHprInterval1 = self.h1.hprInterval(3,
    #                                                    Point3(180, 0, 0),
    #                                                    startHpr=Point3(0, 0, 0))
        
	#pandaHprInterval2 = self.h1.hprInterval(3,
    #                                                    Point3(0, 0, 0),
    #                                                    startHpr=Point3(360, 0, 0))
 
	self.pandaPace3ab = Sequence(pandaPosInterval1c,
                                  #pandaHprInterval1,
                                  #pandaPosInterval2c,
								  #pandaPosInterval3c,
                                  #pandaHprInterval2,
                                  name="pandaPace3ab")
	self.pandaPace3ab.loop()
	#self.lm.append(self.ap5)
	
	self.ap5a = loader.loadModel("Models/cat-vehicles-air/alice-vehicles--boeing707-egg/alice-vehicles--boeing707/boeing707")
	self.ap5a.reparentTo(self.track)
	self.ap5a.setScale(0.80,0.80,0.80)
	self.ap5a.setH(110)
	self.ap5a.setPos(388,554,5)
	
	pandaPosInterval1c = self.ap5a.posInterval(4,
                                                        Point3(230,554,5),
                                                        startPos=Point3(388,554,5))
        
	pandaPosInterval2c= self.ap5a.posInterval(3,
                                                        Point3(-100,554,70),
                                                        startPos=Point3(230,554,5))
	...
	self.pandaPace3abc = Sequence(pandaPosInterval1c,
                                  #pandaHprInterval1,
                                  pandaPosInterval2c,
								  #pandaPosInterval3c,
                                  #pandaHprInterval2,
                                  name="pandaPace3abc")
	self.pandaPace3abc.loop()
	...
	self.targCollider.node().addSolid(CollisionSphere(0,0,0,0.2))
	...
	self.targCollider1.node().addSolid(CollisionSphere(0,0,0,0.05))
	self.targCollider1.node().setFromCollideMask(LOVE_MASK)
	self.cTrav.addCollider(self.targCollider1, self.collisionHandler)
	...
	self.h1 = loader.loadModel("models2/tunnel")
	self.h1.reparentTo(self.track)
	self.h1.setScale(3.09,3.09,3.09)
	self.h1.setPos(-6,-380,-2)
	self.h1.setP(90)
	self.cycle.setPos(-6,-380,0)
	self.cycle.setH(-30)
	
	self.h2 = Actor("Models/cat-humans/bvw-f2004--ralph-egg/bvw-f2004--ralph/ralph", {"walk":"Models/cat-humans/bvw-f2004--ralph-egg/bvw-f2004--ralph/ralph-walk"})
	#Actor("art-gallery/art/models/ralph", {"run":"art-gallery/art/models/ralph-run"})
	self.h2.reparentTo(self.track)
	self.h2.setScale(0.79)
	self.h2.setPos(-205,-181,0)
	self.h2.loop("walk")
	#self.h1.setP(90)
	#self.cycle.setPos(-6,-380,0)
	#self.cycle.setH(-30)
	
	self.h3 = Actor("Models/cat-humans/bvw-f2004--ralph-egg/bvw-f2004--ralph/ralph", {"walk":"Models/cat-humans/bvw-f2004--ralph-egg/bvw-f2004--ralph/ralph-walk"})
	self.h3.reparentTo(self.track)
	self.h3.setScale(0.79)
	self.h3.setPos(-184,-212,0)
	self.h3.setH(210)
	self.h3.loop("walk")
	
	self.h1 = loader.loadModel("Models/cat-sports-equip/alice-sports--football-egg/alice-sports--football/football")
	self.h1.reparentTo(self.track)
	self.h1.setScale(1.59,1.59,1.59)
	self.h1.setPos(-184,-212,3)
	self.cycle.setPos(-184,-212,3)
	self.cycle.setH(-30)
	
	pandaPosInterval11 = self.h1.posInterval(3,
                                                        Point3(-205,-181,2),
                                                        startPos=Point3(-184,-212,2))
        
	pandaPosInterval21 = self.h1.posInterval(3,
                                                        Point3(-205,-181,2),
                                                        startPos=Point3(-184,-212,2))
	...
	self.pandaPace1 = Sequence(pandaPosInterval11,
                                  #pandaHprInterval1,
                                  pandaPosInterval21,
                                  #pandaHprInterval2,
                                  name="pandaPace1")
	...
	self.h4 = Actor("Models/cat-humans/bvw-f2004--ralph-egg/bvw-f2004--ralph/ralph", {"walk":"Models/cat-humans/bvw-f2004--ralph-egg/bvw-f2004--ralph/ralph-walk"})
	#Actor("art-gallery/art/models/ralph", {"run":"art-gallery/art/models/ralph-run"})
	self.h4.reparentTo(self.track)
	self.h4.setScale(0.79)
	self.h4.setPos(-83,-305,0)
	self.h4.loop("walk")
	self.h4.setH(-90)
	#self.cycle.setPos(-6,-380,0)
	#self.cycle.setH(-30)
	
	self.h3a = Actor("Models/cat-humans/bvw-f2004--ralph-egg/bvw-f2004--ralph/ralph", {"walk":"Models/cat-humans/bvw-f2004--ralph-egg/bvw-f2004--ralph/ralph-walk"})
	self.h3a.reparentTo(self.track)
	self.h3a.setScale(0.79)
	self.h3a.setPos(-127,-311,0)
	self.h3a.setH(90)
	self.h3a.loop("walk")
	
	self.h1a = loader.loadModel("Models/cat-sports-equip/alice-sports--football-egg/alice-sports--football/football")
	self.h1a.reparentTo(self.track)
	self.h1a.setScale(1.59,1.59,1.59)
	self.h1a.setPos(-135,-320,3)
	self.cycle.setPos(-135,-320,0)
	self.cycle.setH(-30)
	
	pandaPosInterval1a = self.h1a.posInterval(3,
                                                        Point3(-127,-311,2),
                                                        startPos=Point3(-83,-305,2))
        
	pandaPosInterval2a = self.h1a.posInterval(3,
                                                        Point3(-83,-305,2),
                                                        startPos=Point3(-127,-311,2))
	...
	self.pandaPace2 = Sequence(pandaPosInterval1a,
                                  #pandaHprInterval1,
                                  pandaPosInterval2a,
                                  #pandaHprInterval2,
                                  name="pandaPace2")
	...
	self.h4a = Actor("Models/cat-humans/bvw-f2004--ralph-egg/bvw-f2004--ralph/ralph", {"walk":"Models/cat-humans/bvw-f2004--ralph-egg/bvw-f2004--ralph/ralph-walk"})
	#Actor("art-gallery/art/models/ralph", {"run":"art-gallery/art/models/ralph-run"})
	self.h4a.reparentTo(self.track)
	self.h4a.setScale(0.79)
	self.h4a.setPos(-634,-401,0)
	self.h4a.loop("walk")
	#self.h1.setP(90)
	#self.cycle.setPos(-6,-380,0)
	#self.cycle.setH(-30)
	
	self.h3aa = Actor("Models/cat-humans/bvw-f2004--ralph-egg/bvw-f2004--ralph/ralph", {"walk":"Models/cat-humans/bvw-f2004--ralph-egg/bvw-f2004--ralph/ralph-walk"})
	self.h3aa.reparentTo(self.track)
	self.h3aa.setScale(0.79)
	self.h3aa.setPos(-625,-442,0)
	self.h3aa.setH(210)
	self.h3aa.loop("walk")
	
	self.h3b = Actor("Models/cat-humans/bvw-f2004--ralph-egg/bvw-f2004--ralph/ralph", {"walk":"Models/cat-humans/bvw-f2004--ralph-egg/bvw-f2004--ralph/ralph-walk"})
	self.h3b.reparentTo(self.track)
	self.h3b.setScale(0.79)
	self.h3b.setPos(-571,-451,0)
	self.h3b.setH(210)
	self.h3b.loop("walk")
	
	self.h1b = loader.loadModel("Models/cat-sports-equip/alice-sports--football-egg/alice-sports--football/football")
	self.h1b.reparentTo(self.track)
	self.h1b.setScale(1.59,1.59,1.59)
	self.h1b.setPos(-571,-451,3)
	#self.cycle.setPos(-571,-451,0)
	#self.cycle.setH(-30)
	
	pandaPosInterval1c = self.h1b.posInterval(3,
                                                        Point3(-571,-451,2),
                                                        startPos=Point3(-625,-442,2))
        
	pandaPosInterval2c= self.h1b.posInterval(3,
                                                        Point3(-634,-401,2),
                                                        startPos=Point3(-571,-451,2))
        
	pandaPosInterval3c = self.h1b.posInterval(3,
                                                        Point3(-571,-451,2),
                                                        startPos=Point3(-634,-401,2))
	...
	self.pandaPace3 = Sequence(pandaPosInterval1c,
                                  #pandaHprInterval1,
                                  pandaPosInterval2c,
								  pandaPosInterval3c,
                                  #pandaHprInterval2,
	...
	self.h1ba = loader.loadModel("Models/Locomotive/Locomotive")
	self.h1ba.reparentTo(self.track)
	self.h1ba.setScale(10,15,4)
	self.h1ba.setPos(515,-521,0)
	#self.cycle.setPos(-571,-451,0)
	self.h1ba.setH(40)
	
	pandaPosInterval1c = self.h1ba.posInterval(7,
                                                        Point3(314,-296,0),
                                                        startPos=Point3(515,-521,0))
        
	
	self.pandaPace3a = Sequence(pandaPosInterval1c,
                                  #pandaHprInterval1,
                                  #pandaPosInterval2c,
								  #pandaPosInterval3c,
                                  #pandaHprInterval2,
                                  name="pandaPace3a")
	self.pandaPace3a.loop()
	
	self.h1ba = loader.loadModel("Models/cat-x2-not-yet-classified/bvw-f2004--hotair-egg/bvw-f2004--hotair/ballonmodel")
	self.h1ba.reparentTo(self.track)
	self.h1ba.setScale(0.3)
	self.h1ba.setPos(-494,-31.38,-20)
	#self.cycle.setPos(-571,-451,0)
	#self.h1ba.setH(40)
	
	self.h3aab = Actor("Models/cat-humans/bvw-f2004--ralph-egg/bvw-f2004--ralph/ralph", {"walk":"Models/cat-humans/bvw-f2004--ralph-egg/bvw-f2004--ralph/ralph-walk"})
	self.h3aab.reparentTo(self.track)
	self.h3aab.setScale(0.89)
	self.h3aab.setPos(-508.39,-207.853,0)
	self.h3aab.setH(180)
	self.h3aab.loop("walk")
	
	self.h3aab1 = Actor("Models/cat-humans/bvw-f2004--ralph-egg/bvw-f2004--ralph/ralph", {"walk":"Models/cat-humans/bvw-f2004--ralph-egg/bvw-f2004--ralph/ralph-walk"})
	self.h3aab1.reparentTo(self.track)
	self.h3aab1.setScale(0.89)
	self.h3aab1.setPos(-508.39,-202.853,0)
	self.h3aab1.setH(180)
	self.h3aab1.loop("walk")
	
	self.h3aab2 = Actor("Models/cat-humans/bvw-f2004--ralph-egg/bvw-f2004--ralph/ralph", {"walk":"Models/cat-humans/bvw-f2004--ralph-egg/bvw-f2004--ralph/ralph-walk"})
	self.h3aab2.reparentTo(self.track)
	self.h3aab2.setScale(0.89)
	self.h3aab2.setPos(-508.39,-197.853,0)
	self.h3aab2.setH(180)
	self.h3aab2.loop("walk")
	
	pandaPosInterval1c = self.h3aab.posInterval(6,
                                                        Point3(-494,-31.38,0),
                                                        startPos=Point3(-508.39,-207.853,0))
        
	pandaPosInterval1cd = self.h3aab.posInterval(0.2,
                                                        Point3(0,0,0),
                                                        startPos=Point3(-494,-31.38,0))
	pandaPosInterval1c1 = self.h3aab1.posInterval(6,
                                                        Point3(-494,-31.38,0),
                                                        startPos=Point3(-508.39,-202.853,0))
        
	pandaPosInterval1cd1 = self.h3aab1.posInterval(0.2,
                                                        Point3(0,0,0),
                                                        startPos=Point3(-494,-31.38,0))
															
	pandaPosInterval1c2 = self.h3aab2.posInterval(6,
                                                        Point3(-494,-31.38,0),
                                                        startPos=Point3(-508.39,-197.853,0))
        
	pandaPosInterval1cd2 = self.h3aab2.posInterval(0.2,
                                                        Point3(0,0,0),
                                                        startPos=Point3(-494,-31.38,0))
	
	pandaPosInterval2c= self.h1ba.posInterval(12,
                                                        Point3(-494,-31.38,20),
                                                        startPos=Point3(-494,-31.38,0))
        
	pandaPosInterval3c = self.h1ba.posInterval(12,
                                                        Point3(-494,-31.38,0),
                                                        startPos=Point3(-494,-31.38,20))
	...
	self.pandaPace3an = Sequence(pandaPosInterval1c,
	
									#self.h3aab.reparentTo(self.h1ba),
                                  #pandaHprInterval1,
                                  
								  pandaPosInterval1cd,
								  pandaPosInterval1c1,
								  pandaPosInterval1cd1,
								  pandaPosInterval1c2,
								  pandaPosInterval1cd2,
								  pandaPosInterval2c,
								  #self.h3aab.reparentTo(self.track),
								  pandaPosInterval3c,
                                  #pandaHprInterval2,
                                  name="pandaPace3an")
	self.pandaPace3an.loop()
	
	
	
	self.h3aab1 = Actor("Models/cat-humans/bvw-f2004--ralph-egg/bvw-f2004--ralph/ralph", {"walk":"Models/cat-humans/bvw-f2004--ralph-egg/bvw-f2004--ralph/ralph-walk"})
	#self.h3aab1.reparentTo(self.track)
	self.h3aab1.setScale(1.89)
	self.h3aab1.setPos(2.39,2.853,0)
	self.h3aab1.setH(180)
	self.h3aab1.loop("walk")
	
	dummyNode = self.track.attachNewNode("dummyNode")
	self.h3aab1.reparentTo(dummyNode)
	#myOtherModel.reparentTo(dummyNode)
	
	self.h3aab12 = Actor("Models/cat-humans/bvw-f2004--ralph-egg/bvw-f2004--ralph/ralph", {"walk":"Models/cat-humans/bvw-f2004--ralph-egg/bvw-f2004--ralph/ralph-walk"})
	#self.h3aab1.reparentTo(self.track)
	self.h3aab12.setScale(2.89)
	self.h3aab12.setPos(2,16,0)
	self.h3aab12.setH(180)
	self.h3aab12.loop("walk")
	self.h3aab12.reparentTo(dummyNode)
	
	dummyNode.setPos(-524.39,-197.853,0)
	
	pandaPosInterval1c = self.h3aab1.posInterval(7,
                                                        Point3(2.39,56,0),
                                                        startPos=Point3(2.39,2.853,0))
        
	
	self.pandaPace3a12 = Sequence(pandaPosInterval1c,
                                  #pandaHprInterval1,
                                  #pandaPosInterval2c,
								  #pandaPosInterval3c,
                                  #pandaHprInterval2,
                                  name="pandaPace3a12")
	self.pandaPace3a12.loop()
	
	dummyNode1 = self.track.attachNewNode("dummyNode1")
	dummyNode1.setPos(-303,-308.878,0)
	self.h1ba1 = loader.loadModel("Models/Coachcar/Coachcar")
	#self.h1ba1.reparentTo(self.track)
	self.h1ba1.setScale(0.40)
	self.h1ba1.setH(-45)
	#self.h1ba1.setPos(-494,-31.38,-20)
	self.h1ba1.reparentTo(dummyNode1)
	
	self.h3aab12 = Actor("Models/cat-humans/bvw-f2004--ralph-egg/bvw-f2004--ralph/ralph", {"walk":"Models/cat-humans/bvw-f2004--ralph-egg/bvw-f2004--ralph/ralph-walk"})
	#self.h3aab1.reparentTo(self.track)
	self.h3aab12.setScale(0.59)
	self.h3aab12.setPos(-23,-10,0)
	self.h3aab12.setH(0)
	self.h3aab12.loop("walk")
	self.h3aab12.reparentTo(dummyNode1)
	
	self.h3aab12a = Actor("Models/cat-humans/bvw-f2004--ralph-egg/bvw-f2004--ralph/ralph", {"walk":"Models/cat-humans/bvw-f2004--ralph-egg/bvw-f2004--ralph/ralph-walk"})
	#self.h3aab1.reparentTo(self.track)
	self.h3aab12a.setScale(0.59)
	self.h3aab12a.setPos(-70,-50,0)
	self.h3aab12a.setH(0)
	self.h3aab12a.loop("walk")
	self.h3aab12a.reparentTo(dummyNode1)
	
	
	self.h3aab12u = Actor("Models/cat-humans/bvw-f2004--ralph-egg/bvw-f2004--ralph/ralph", {"walk":"Models/cat-humans/bvw-f2004--ralph-egg/bvw-f2004--ralph/ralph-walk"})
	#self.h3aab1.reparentTo(self.track)
	self.h3aab12u.setScale(0.59)
	self.h3aab12u.setPos(-113,-90,0)
	self.h3aab12u.setH(0)
	self.h3aab12u.loop("walk")
	self.h3aab12u.reparentTo(dummyNode1)
	
	
	pandaPosInterval1c = self.h1ba1.posInterval(4,
                                                        self.h3aab12.getPos()+Point3(10,0,0),
                                                        startPos=self.h1ba1.getPos())
        
	pandaPosInterval1cd2 = self.h3aab2.posInterval(2,
                                                        self.h3aab12.getPos()+Point3(10,0,0),
                                                        startPos=self.h3aab12.getPos()+Point3(10,0,0))
	
	pandaPosInterval1cd21 = self.h3aab12.posInterval(2,
                                                        self.h3aab12.getPos()+Point3(10,0,0),
                                                        startPos=self.h3aab12.getPos())
	pandaPosInterval1cd = self.h1ba1.posInterval(4,
                                                        self.h3aab12a.getPos()+Point3(10,0,0),
                                                        startPos=self.h3aab12.getPos()+Point3(10,0,0))
														
	pandaPosInterval1cd1 = self.h1ba1.posInterval(2,
                                                        self.h3aab12a.getPos()+Point3(10,0,0),
                                                        startPos=self.h3aab12a.getPos()+Point3(10,0,0))													
	
	pandaPosInterval1cd1a = self.h3aab12a.posInterval(2,
                                                        self.h3aab12a.getPos()+Point3(10,0,0),
                                                        startPos=self.h3aab12a.getPos())
	
	pandaPosInterval1c1 = self.h1ba1.posInterval(6,
                                                        self.h3aab12u.getPos()+Point3(10,0,0),
                                                        startPos=self.h3aab12a.getPos()+Point3(10,0,0))
        
	
															
	pandaPosInterval1c2 = self.h1ba1.posInterval(2,
                                                        self.h3aab12u.getPos()+Point3(10,0,0),
                                                        startPos=self.h3aab12u.getPos()+Point3(10,0,0))
        
	pandaPosInterval1c3 = self.h3aab12u.posInterval(2,
                                                        self.h3aab12u.getPos()+Point3(10,0,0),
                                                        startPos=self.h3aab12u.getPos())
	
	
	#pandaPosInterval2c= self.h1ba1.posInterval(8,
     #                                                   Point3(-479,-469,0),
      #                                                  startPos=self.h3aab12u.getPos()+Point3(10,0,0))
	...
	self.pandaPace3an1 = Sequence(pandaPosInterval1c,
	
									#self.h3aab.reparentTo(self.h1ba),
                                  #pandaHprInterval1,
                                  
								  pandaPosInterval1cd2,
								  #pandaPosInterval1cd21,
								  pandaPosInterval1cd,
								  pandaPosInterval1cd1,
								  #pandaPosInterval1cd1a,
								  pandaPosInterval1c1,
								  pandaPosInterval1c2,
								  #pandaPosInterval2c,
								  #pandaPosInterval1c3,
			...
			#					  pandaPosInterval3c,
                                  #pandaHprInterval2,
                                  name="pandaPace3an1")
	self.pandaPace3an1.loop()
	
	self.tr1 = loader.loadModel("Models/Locomotive/Locomotive")
	self.tr1.reparentTo(self.track)
	self.tr1.setScale(3.59,22,4)
	self.tr1.setPos(-240,-575.65,0)
	self.tr1.setH(-90)
	#self.tr1.loop("walk")
	
	self.tr2 = loader.loadModel("Models/Locomotive/Locomotive")
	self.tr2.reparentTo(self.track)
	self.tr2.setScale(3.59,22,4)
	self.tr2.setPos(-150,-575.65,0)
	self.tr2.setH(-90)
	
	self.tr3 = loader.loadModel("Models/Locomotive/Locomotive")
	self.tr3.reparentTo(self.track)
	self.tr3.setScale(3.59,22,4)
	self.tr3.setPos(-50,-575.65,0)
	self.tr3.setH(-90)
	
	pandaPosInterval1c = self.tr1.posInterval(12,
                                                        Point3(20.39,-575.65,0),
                                                        startPos=Point3(-240,-575.65,0))
        
	pandaPosInterval1ca = self.tr2.posInterval(12,
                                                        Point3(110.39,-575.65,0),
                                                        startPos=Point3(-150,-575.65,0))
														
	pandaPosInterval1cb = self.tr3.posInterval(12,
                                                        Point3(200.39,-575.65,0),
                                                        startPos=Point3(-50,-575.65,0))
	self.pandaPace3a12b = Parallel(pandaPosInterval1c,
                                  #pandaHprInterval1,
                                  pandaPosInterval1ca,
								  pandaPosInterval1cb,
                                  #pandaHprInterval2,
                                  name="pandaPace3a12b")
	self.pandaPace3a12b.loop()
	
	
	self.cycle.setPos(-132,-545.65,0)
	#self.cycle.setH(-30)
	self.visited = []
	for i in range(len(self.heartModel1)):
