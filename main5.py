...
#		self.loadmenu()
 ...
 def setlig(self, task):
	for i in range(len(self.lm)):
		if(((abs(abs(self.cycle.getX())) -(abs(self.lm[i].getX()))) >= 50) and ((abs((abs(self.cycle.getY()))-(abs(self.lm[i].getY()))))>=50) ):
			#print(self.lm[i],self.lm[i].getPos())
			self.lm[i].detachNode()
			#self.lm[i].setColor(0.4,0.4,0.4,0.4)
		#else:
	...
	for i in range(len(self.treeModel1)):
		...
		#else:
			#self.lm[i].reparentTo(self.track)
		if(((abs(abs(self.cycle.getX())) -(abs(self.treeModel1[i].getX()))) > 40) and ((abs((abs(self.cycle.getY()))-(abs(self.treeModel1[i].getY()))))>40) ):
			#print(self.heartModel1[i],self.heartModel1[i].getPos())
 ...
 def createmap(self ):
	...
	self.h3aab2.setH(210)
	self.h3aab2.loop("walk")
	
	pandaPosInterval1c = self.h3aab.posInterval(3,
                                                        Point3(-494,-31.38,0),
	...
	pandaPosInterval1c1 = self.h3aab1.posInterval(3,
                                                        Point3(-494,-31.38,0),
	...
	pandaPosInterval1c2 = self.h3aab2.posInterval(3,
                                                        Point3(-494,-31.38,0),
	...
	self.cycle.setPos(-508.39,-207.853,0)
	#self.cycle.setH(-30)
	self.visited = []
	for i in range(len(self.heartModel1)):
 ...
 def turnHead(self, task):
    #Check to make sure the mouse is readable
      ...
      #significant tearing would be visable
			self.effobj.actorNeck1.setP(restrain(mpos.getX()) * 50)
			#self.actorNeck2.setP(restrain(mpos.getX()) * 50)
			self.effobj.actorNeck1.setH(restrain(mpos.getY()) * 20)
			#self.actorNeck2.setH(restrain(mpos.getY()) * 20)
